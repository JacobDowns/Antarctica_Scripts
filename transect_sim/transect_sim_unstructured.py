...
you can play around with these however you like."""

set_log_active(True)

# Directory to write results
out_dir = 'transect_results_unstructured/'
...
#Beta2   = Expression(  '10 - 5 * sin(4*pi*x[0]/L)',
#                     alpha=alpha, L=xmax)      
                     
# Deform the model geometry to the surface and bed expressions
